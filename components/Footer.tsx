      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-12 gap-y-8 gap-x-4 md:gap-12 pb-8 md:pb-16 border-b border-brand-cream/10">
          ...
          <div className="col-span-12 md:col-span-5 space-y-4">
            ...
            <p className="text-xs md:text-sm text-brand-cream/70 font-light leading-relaxed max-w-sm line-clamp-2 md:line-clamp-none">
            ...
            <div className="flex gap-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 bg-brand-cream/10 hover:bg-brand-orange text-brand-cream hover:text-white rounded-full flex items-center justify-center transition-colors"
          ...
          <div className="col-span-6 md:col-span-4 space-y-3">
            <h4 className="font-heading text-xs md:text-base font-bold text-brand-yellow uppercase tracking-wider md:normal-case">Contacto</h4>
        ...
        {/* Bottom row */}
        <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-[10px] sm:text-xs text-brand-cream/40 border-t border-brand-cream/5 mt-8 md:mt-0 md:border-t-0 md:pt-8">
