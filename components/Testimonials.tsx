  ...
  const testimonials = [
    {
      ...
      event: "Matrimonio Campestre en Rionegro",
      text: "Alquilamos 5 meseros y toda la vajilla por 8 horas. Llegaron súper puntuales, impecables y con una amabilidad increíble. Mis invitados quedaron encantados con el servicio y a mí me quitó todo el estrés del montaje.",
      rating: 5,
    },
    {
      name: "Andrés Cardona",
      event: "Asado Familiar de Cumpleaños en Bogotá",
      text: "Contratamos un cocinero experto en asados por 4 horas y fue la mejor decisión. La comida estuvo espectacular, todo a tiempo y dejó la cocina impecable al terminar. Definitivamente volveré a usar Fiesta.",
      rating: 5,
    },
    {
      name: "Mariana Silva",
      event: "Catering y Mobiliario para Evento Corporativo",
      text: "La flexibilidad de contratar solo por las horas exactas del evento nos ahorró mucho presupuesto. El catering estuvo delicioso y el mobiliario lounge le dio un toque muy moderno a nuestra oficina.",
      rating: 5,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20 space-y-3 md:space-y-4">
          ...
          <p className="text-sm sm:text-lg text-brand-brown/80 font-light px-2 sm:px-0">
            Mira lo que opinan quienes ya han vivido la experiencia de organizar sus eventos con Fiesta.
          </p>
        </div>
