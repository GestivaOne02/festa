  ...
  return (
    <section id="servicios" className="pt-14 pb-10 md:py-24 bg-brand-cream relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 space-y-4 bg-brand-cream rounded-[2rem] border border-brand-orange/5 shadow-sm">
            <div className="w-10 h-10 border-4 border-brand-orange border-t-transparent rounded-full animate-spin" />
            <p className="text-sm text-brand-brown/70 font-light">Cargando servicios de la base de datos...</p>
          </div>
        ) : servicesList.length === 0 ? (
          <div className="text-center p-8 sm:p-12 bg-brand-cream border-2 border-dashed border-brand-orange/20 rounded-[2.5rem] max-w-xl mx-auto space-y-4 shadow-sm">
            <div className="text-4xl">✨</div>
            <h3 className="font-heading text-lg sm:text-xl text-brand-brown font-bold">Sin servicios configurados</h3>
            <p className="text-xs sm:text-sm text-brand-brown/70 leading-relaxed font-light">
              ...
              Asegúrate de agregar productos con la unidad de medida <code className="bg-brand-orange/10 px-2 py-1 rounded text-brand-orange font-mono mx-1">HORA</code> en tu POS.
            </p>
          </div>
        ) : (
          <>
                  ...
                  <div>
                    ...
                    <div className="relative h-40 sm:h-56 w-full overflow-hidden bg-brand-orange/10 aspect-[16/10] sm:aspect-auto">
                      <Image
                        ...
                        alt={`${service.title} - Servicio profesional de Fiesta`}
                        fill
