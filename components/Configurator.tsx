    ...
    <section id="cotizador" className="pt-14 pb-8 lg:py-20 bg-secondary-white/[0.02] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:grid grid-cols-12 gap-8 items-start">
          ...
          <div className="col-span-7 bg-dark-bg border border-primary-gold/10 p-8 rounded-[2rem] shadow-xl space-y-8">
          ...
          <div className="col-span-5 bg-secondary-white text-dark-bg p-8 rounded-[2rem] shadow-xl sticky top-24 space-y-6">
            <div className="flex items-center gap-2 pb-4 border-b border-dark-bg/10">
            ...
            <div className="border-t border-dark-bg/10 pt-4 flex flex-col gap-1">
              <div className="flex justify-between items-baseline">
                <span className="text-primary-gold font-heading font-semibold text-lg">Total Estimado</span>
                <span className="text-3xl font-heading font-bold text-primary-gold tracking-wider font-mono">
                  {formatCOP(totalCost)}
                </span>
              </div>
              <p className="text-[10px] text-dark-bg/50 text-right">Precios de referencia aproximados. No contractual.</p>
            </div>
              ...
              {!isBooked ? (
                ...
                >
                  <input
                    ...
                    className="w-full px-4 py-3 bg-dark-bg/10 border border-dark-bg/20 rounded-xl focus:border-primary-gold focus:outline-none placeholder-dark-bg/40 text-dark-bg text-sm transition-colors"
                  />
                  <input
                    type="tel"
                    required
                  ...
                  <div className="grid grid-cols-2 gap-3 text-left">
                    <div className="space-y-1">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2.5 bg-dark-bg/10 border border-dark-bg/20 rounded-xl focus:border-primary-gold focus:outline-none text-dark-bg text-xs transition-colors"
                      />
                    </div>
                    <div className="space-y-1">
                  ...
                  <button
                    ...
                    className="w-full bg-primary-gold hover:bg-primary-gold-dark text-white font-bold py-3.5 rounded-xl transition-all shadow-md flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                  >
                    {isSubmitLoading ? (
                ...
                <motion.div
                  key="success"
                  className="bg-dark-bg/10 border border-primary-gold/30 p-5 rounded-2xl text-center space-y-3"
            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                <motion.div
                  ...
                  className="space-y-6 bg-dark-bg border border-primary-gold/10 p-6 rounded-[2rem] shadow-md"
                >
                  {/* Slider Duration */}
              ...
              {step === 2 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 15 }}
                  transition={{ duration: 0.2 }}
                  className="space-y-3 bg-dark-bg border border-primary-gold/10 p-5 rounded-[2rem] shadow-md"
                >
              ...
              {step === 3 && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: 15 }}
                  transition={{ duration: 0.2 }}
                  className="bg-secondary-white text-dark-bg p-6 rounded-[2rem] shadow-xl space-y-6"
                >
                  <div className="flex items-center gap-2 pb-3 border-b border-dark-bg/10">
                    <Calculator className="w-5 h-5 text-primary-gold" />
                    <h3 className="font-heading text-base font-bold text-primary-gold">Resumen Final</h3>
                  </div>
                  ...
                  <div className="border-t border-dark-bg/10 pt-4 flex flex-col gap-1">
                    <div className="flex justify-between items-baseline">
                      <span className="text-primary-gold font-heading font-semibold">Total Estimado</span>
                      <span className="text-2xl font-heading font-bold text-primary-gold tracking-wider font-mono">
                        {formatCOP(totalCost)}
                      </span>
                    </div>
                  </div>
                    ...
                    {!isBooked ? (
                      <form onSubmit={handleBookSubmit} className="space-y-2.5">
                        <input
                          ...
                          value={userName}
                          onChange={(e) => setUserName(e.target.value)}
                          className="w-full px-4 py-3 bg-dark-bg/10 border border-dark-bg/20 rounded-xl focus:border-primary-gold focus:outline-none placeholder-dark-bg/30 text-dark-bg text-xs transition-colors"
                        />
                        <input
                          type="tel"
                          required
                        ...
                        <button
                          type="submit"
                          disabled={totalCost === 0 || isSubmitLoading}
                          className="w-full bg-primary-gold hover:bg-primary-gold-dark text-white font-bold py-3.5 rounded-xl transition-all shadow-md flex items-center justify-center gap-1.5 text-xs cursor-pointer disabled:opacity-50"
                        >
                          {isSubmitLoading ? (
                      ...
                      <div className="bg-dark-bg/10 border border-primary-gold/20 p-4 rounded-xl text-center space-y-2.5">
